...
import { Logs, Search, User, X } from "lucide-react";
      ...
      <div className="py-3">
        <Container>
          ...
          <div className="hidden md:flex items-center justify-between">
            ...
            {/* Center - HeaderMenu or Search Bar */}
            ...
            {/* Right side - Search + WhatsApp + Icons */}
            <div className="flex items-center gap-4">
              {/* Search/Close Icon - Toggle between Search and X */}
              <button
              ...
              <WhatsAppLink
                ...
                className="text-green-800 hover:text-green-500 transition-colors duration-200"
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
